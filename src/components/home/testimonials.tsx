  ...
  return (
    <div className="max-w-7xl w-full p-6 space-y-10 mx-auto relative">
      <div className="flex justify-between items-end">
        <div className="text-white text-2xl md:4xl lg:text-5xl xl:text-7xl font-bold font-syne">
          Testimonials
        </div>
        <div className="rotate-180 text-[150px] md:text-[170px] lg:text-[200px] xl:text-[288px] font-extrabold font-syne">
          “
        </div>
      </div>
      <div className="w-[80%] text-neutral-400 text-lg font-normal font-rubik">
      ...
      <div className="w-[193.57px] h-[38.72px] left-[5px] top-[381px] text-white text-lg md:text-2xl font-bold font-syne">
        -Martin lee
      </div>
    </div>
  );
