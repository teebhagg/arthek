  ...
  return (
    <div className="max-w-7xl w-full p-6 mx-auto flex flex-col items-center justify-center space-y-16">
      ...
      <div className="text-center text-white text-7xl font-bold font-syne relative">
        <p>{title}</p>
        <div className="w-52 h-52 z-[-25px] backdrop-blur-sm bg-white opacity-20 absolute rounded-full top-[-30px] right-[-30px] animate-bounce animate-duration-[3000ms]"></div>
      </div>
